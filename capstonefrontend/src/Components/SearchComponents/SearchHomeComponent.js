...
const findAllButtonText = <Typography variant="h5">Show All</Typography>;
const myDivStyle = {
  flex: 1000,
  width: 1000,
  paddingTop: "10%",
...
function SearchHomeComponent() {
  ...
  return (
    <div>
      <div style={text}>Find a Booking Near You!</div>
      <Container>
  ...
  return (
    <React.Fragment>
      <Autocomplete
        ...
        freeSolo
        renderInput={(params) => (
          <TextField {...params} label="Search for Service Providers" />
        )}
      />
    </React.Fragment>
  );
